    ...
    return (
      <header className="flex h-11 items-center justify-between border-b border-white/10 bg-[#0B0D12]/90 px-4 backdrop-blur-xl">
        ...
        <button
          type="button"
          onClick={onToggle}
          className="agentify-action rounded-md border border-white/10 px-2.5 py-1 text-xs text-slate-400 transition hover:border-white/20 hover:bg-white/[0.04] hover:text-white"
        >
          Expand
        </button>
      </header>
      ...
      <div className="flex items-center justify-between gap-4">
        <div className="flex min-w-0 items-center gap-3">
          <button
            type="button"
            onClick={onToggle}
            className="agentify-action hidden rounded-md border border-white/10 px-2.5 py-2 text-xs text-slate-500 transition hover:border-white/20 hover:bg-white/[0.04] hover:text-slate-100 md:block"
          ...
          {user && (
            <>
              ...
              <button
                type="button"
                onClick={logout}
                className="agentify-action rounded-md border border-white/10 bg-white/[0.035] px-2.5 py-2 text-xs font-medium text-slate-300 transition hover:border-rose-300/30 hover:bg-rose-300/10 hover:text-rose-200 md:px-3"
              >
                Log out
              </button>
            </>
